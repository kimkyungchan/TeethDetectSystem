...
// (참고로 Toast에서는 Context가 필요했습니다.)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayout = v.findViewById(R.id.layout_main1);
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(MapsFragment.this)
                .key("AIzaSyBzkTye8rofULvSFJwCfiaobKnn5FetSDA")
                .latlng(location.latitude, location.longitude)//현재 위치n
                .radius(2000) //2000미터
